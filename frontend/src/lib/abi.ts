...
export const covenantAbi = [
  ...
  {
    type: "function",
    name: "requesterDisputeEvidenceUri",
    stateMutability: "view",
    inputs: [{ name: "", type: "uint256" }],
    outputs: [{ name: "", type: "string" }],
  },
  ...
  {
    type: "function",
    name: "arbiterResolutionEvidenceUri",
    stateMutability: "view",
    inputs: [{ name: "", type: "uint256" }],
    outputs: [{ name: "", type: "string" }],
  },
