...
- 監査ログには **Executed by ... as ...** を表示し、暫定運営権限の行使主体を見える化している。

## Phase1 dispute fairness 方針
...
- arbiter は proposal 前に `Claim summary / Requester response / Missing evidence / gaps / Recommended payout` を残す。
- 詳細: `docs/phase1_dispute_fairness_ja.md`
